...
2. 解压 `Bangumi-Vault-v0.31.2-source.zip`。
3. 将源码文件上传到仓库根目录。
...
git init
git add .
git commit -m "Initial release v0.31.2"
...
```text
Bangumi-Vault-0.31.2-win-x64.exe
Bangumi-Vault-v0.31.2-source.zip
```

Release 说明可以直接复制 `docs/RELEASE_NOTES_v0.31.2.md`。
